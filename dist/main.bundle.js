...
module.exports = "<footer class=\"footer \">\r\n    <div class=\"container-fluid\">\r\n        <nav class=\"pull-left\">\r\n            <ul>\r\n                <li>\r\n                    <a href=\"https://www.ucuenca.edu.ec/\" target=\"_blank\">\r\n                        Ucuenca\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n        </nav>\r\n        <div class=\"copyright pull-right\">\r\n            &copy;\r\n            {{test | date: 'yyyy'}}, Hecho por los \r\n            <a href=\"/devs\" >Estudiantes de la Universidad de Cuenca</a>\r\n        </div>\r\n    </div>\r\n</footer>\r\n"
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-transparent  navbar-absolute fixed-top\">\r\n    <div class=\"container-fluid\">\r\n        <div class=\"navbar-wrapper\">\r\n          <a class=\"navbar-brand\" target=\"_blank\" href=\"https://github.com/TheWorstOne/SimpleMongoCRUD\">{{getTitle()}}</a>\r\n        </div>\r\n        <button mat-raised-button class=\"navbar-toggler\" type=\"button\" (click)=\"sidebarToggle()\">\r\n            <span class=\"sr-only\">Toggle navigation</span>\r\n            <span class=\"navbar-toggler-icon icon-bar\"></span>\r\n            <span class=\"navbar-toggler-icon icon-bar\"></span>\r\n            <span class=\"navbar-toggler-icon icon-bar\"></span>\r\n        </button>\r\n        <div class=\"collapse navbar-collapse justify-content-end\" id=\"navigation\">\r\n            <ul class=\"navbar-nav\">\r\n                <!--\r\n                <li class=\"nav-item\">\r\n                    <a class=\"nav-link\" href=\"#\">\r\n                        <i class=\"material-icons\">dashboard</i>\r\n                        <p>\r\n                            <span class=\"d-lg-none d-md-block\">Stats</span>\r\n                        </p>\r\n                    </a>\r\n                </li>\r\n                <li class=\"nav-item dropdown\">\r\n                    \r\n                    <a class=\"nav-link\" href=\"#\" id=\"navbarDropdownMenuLink\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\r\n                        <i class=\"material-icons\">notifications</i>\r\n                        <span class=\"notification\">3</span>\r\n                        <p>\r\n                            <span class=\"d-lg-none d-md-block\">Some Actions</span>\r\n                        </p>\r\n                    </a>\r\n                    \r\n                    <div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"navbarDropdownMenuLink\">\r\n                            <a class=\"dropdown-item\" href=\"#\">Se han ingresado nuevos Equipos</a>\r\n                            <a class=\"dropdown-item\" href=\"#\">Se han ingresado nuevos Instrumentos</a>\r\n                            <a class=\"dropdown-item\" href=\"#\">Se han ingresado nuevos Insumos</a>\r\n                    \r\n                    </div>\r\n                    \r\n                </li>\r\n                <li class=\"nav-item\">\r\n                    <a class=\"nav-link\" href=\"#\">\r\n                        <i class=\"material-icons\">person</i>\r\n                        <p>\r\n                            <span class=\"d-lg-none d-md-block\">Account</span>\r\n                        </p>\r\n                    </a>\r\n                </li>\r\n                -->\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</nav>\r\n"
...
module.exports = ".active .nav-link  {\r\n    background-color: #3E50B4 !important; /*Violet Blue*/\r\n    -webkit-box-shadow: 0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(67, 54, 244, 0.4);\r\n            box-shadow: 0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(67, 54, 244, 0.4);\r\n}"
...
var endpoint = 'https://airlines-backend.netlify.app/.netlify/functions/app/flights/';
var httpOptions = {
...
var RestService = (function () {
    ...
    RestService.prototype.getFlightNumber = function (number) {
        return this.http.get(endpoint + 'number/' + number).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["b" /* map */])(this.extractData));
    };
    RestService.prototype.addNewFlight = function (flight) {
        console.log(flight);
        return this.http.post(endpoint + 'new', JSON.stringify(flight), httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["c" /* tap */])(function (flight) { return console.log("generate flights w/ id=" + flight); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* catchError */])(this.handleError('generar Vuelo')));
    };
    RestService.prototype.updateFlight = function (_id, flight) {
        console.log(flight);
        return this.http.put(endpoint + 'update/' + _id, JSON.stringify(flight), httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["c" /* tap */])(function (flight) { return console.log("generate flights w/ id=" + flight); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* catchError */])(this.handleError('actualizar Vuelo')));
    };
    RestService.prototype.deleteFlight = function (_id) {
        console.log();
        return this.http.delete(endpoint + 'delete/' + _id, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["c" /* tap */])(function (flight) { return console.log("delete flight w/ id=" + flight); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* catchError */])(this.handleError('eliminar vuelo')));
    };
